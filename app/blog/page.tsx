...
/* ─────────────────────────────────────────────
   FEATURED HERO CARD (first blog)
───────────────────────────────────────────── */
function HeroCard({ blog }: { blog: (typeof blogs)[0] }) {
  return (
    <motion.div
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-7 md:p-10">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-white/60 text-xs font-satoshi">
                {blog.readingTime}
              </span>
              <span className="ml-auto text-white/50 text-xs font-satoshi hidden md:block">
                {blog.date}
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-8 h-8 rounded-xl bg-green-600 flex items-center justify-center shrink-0">
                <span className="font-figtree font-black text-white text-xs">
                  MT
                </span>
              </div>
              <span className="font-satoshi text-white/80 text-sm font-medium">
                {blog.author}
              </span>
          ...
          <div className="p-6 flex flex-col flex-1">
            ...
            <div className="flex items-center gap-2.5 pt-4 border-t border-gray-100">
              <div className="w-7 h-7 rounded-lg bg-green-600 flex items-center justify-center shrink-0">
                <span className="font-figtree font-black text-white text-[10px]">
                  MT
                </span>
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-satoshi font-semibold text-gray-800 text-xs leading-tight truncate">
                  {blog.author}
                </p>
                <p className="font-satoshi text-gray-400 text-[11px] mt-0.5">
                  {blog.date}
                </p>
              </div>
      ...
      <div className="w-11/12 md:w-10/12 max-w-6xl mx-auto">
        ...
        >
          <div>
            ...
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="font-satoshi text-green-600 text-xs font-bold uppercase tracking-[0.18em]">
                From the Court
              </span>
            </div>
        ...
        >
          ...
          {filtered.length === 0 && (
            ...
            >
              ...
              <p className="font-figtree text-gray-400 text-lg font-semibold">
        ...
        >
          ...
          <div className="relative z-10">
            <p className="font-satoshi text-green-200 text-xs font-bold uppercase tracking-widest mb-2">
              Come Play With Us
            </p>
            ...
            <p className="font-satoshi text-green-100/80 text-sm mt-2">
              Rooftop, Haque Tower · Jubilee Road, Chattogram
            </p>
          </div>
