...
const Hero = () => {
  ...
  return (
    <div className="relative  bg-white overflow-hidden mt-5 md:mt-10">
      ...
      <div className="text-center max-w-5xl mx-auto mb-12">
       <h1 className="text-[28px] md:text-[60px] lg:text-[80px] font-geist font-bold md:font-semibold mb-2  md:leading-none px-2 md:px-0">
  ...
  <span className="text-black block">Starts Here in Chittagong!</span>
        ...
        <p className="text-[#707070] max-w-4xl px-4 font-geist xl md:text-2xl mb-3 mx-auto">
      ...
      {/* Background Marquee */}
      <div className="absolute mt-113  inset-0 flex  overflow-hidden ">
        {/* LEFT FADE */}
